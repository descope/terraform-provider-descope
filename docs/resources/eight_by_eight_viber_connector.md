...
page_title: "descope_eight_by_eight_viber_connector Resource - descope"
subcategory: ""
description: |-
  Manages a 8x8 for Viber connector and its configuration in a Descope project. Use the connector to send Viber messages to the user.
---

# descope_eight_by_eight_viber_connector (Resource)
