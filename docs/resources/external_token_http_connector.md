...
page_title: "descope_external_token_http_connector Resource - descope"
subcategory: ""
description: |-
  Manages a Generic HTTP Token connector and its configuration in a Descope project. A generic HTTP token connector.
---

# descope_external_token_http_connector (Resource)
