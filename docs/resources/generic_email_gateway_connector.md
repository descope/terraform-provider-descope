...
page_title: "descope_generic_email_gateway_connector Resource - descope"
subcategory: ""
description: |-
  Manages a Generic Email gateway connector and its configuration in a Descope project. Send emails using a generic Email gateway.
---

# descope_generic_email_gateway_connector (Resource)
