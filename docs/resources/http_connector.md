...
page_title: "descope_http_connector Resource - descope"
subcategory: ""
description: |-
  Manages a Generic HTTP connector and its configuration in a Descope project. A general purpose HTTP client.
---

# descope_http_connector (Resource)
