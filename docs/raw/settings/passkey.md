...
Setting this to `true` will disallow using passkey authentication directly via API and SDK calls.
...
The human-friendly name shown to users when they create or use a passkey. Some password managers
