...
func InjectModels() {
	...
	inject(authentication.OAuthProviderCustomAttributes, docsOAuthProviderCustom)
	inject(authentication.OAuthProviderSystemAttributes, docsOAuthProviderSystem)
	inject(authentication.OAuthProviderAppleAttributes, docsOAuthProviderApple)
	inject(authentication.OAuthProviderAppleKeyGeneratorAttributes, docsOAuthProviderAppleKeyGenerator)
