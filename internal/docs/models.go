...
func InjectModels() {
	...
	inject(inboundapp.ScopeClaimMappingAttributes, docsInboundScopeClaimMapping)
	...
	inject(project.ScopeClaimMappingAttributes, docsProjectScopeClaimMapping)
	...
	inject(applications.ScopeClaimMappingAttributes, docsFederatedScopeClaimMapping)
