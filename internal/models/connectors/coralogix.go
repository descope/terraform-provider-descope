...
// descope_coralogix_connector is a standalone Coralogix connector with a server-assigned id.

var CoralogixConnectorSchema = schema.Schema{
	MarkdownDescription: "Manages a Coralogix connector and its configuration in a Descope project. Send audit events and troubleshooting logs to Coralogix.",
	Attributes:          CoralogixConnectorAttributes,
}

var CoralogixConnectorAttributes = map[string]schema.Attribute{
...
type CoralogixConnectorModel struct {
...
func (m *CoralogixConnectorModel) Values(h *helpers.Handler) map[string]any {
	data := map[string]any{}
...
func (m *CoralogixConnectorModel) SetValues(h *helpers.Handler, data map[string]any) {
...
func (m *CoralogixConnectorModel) Validate(h *helpers.Handler) {
...
func (m *CoralogixConnectorModel) ConfigurationValues(h *helpers.Handler) map[string]any {
	c := map[string]any{}
...
func (m *CoralogixConnectorModel) GetID() stringattr.Type        { return m.ID }
func (m *CoralogixConnectorModel) SetID(id stringattr.Type)      { m.ID = id }
func (m *CoralogixConnectorModel) GetProjectID() stringattr.Type { return m.ProjectID }
