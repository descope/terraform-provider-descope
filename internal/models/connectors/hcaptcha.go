...
// descope_hcaptcha_connector is a standalone hCaptcha connector with a server-assigned id.

var HCaptchaConnectorSchema = schema.Schema{
	MarkdownDescription: "Manages a hCaptcha connector and its configuration in a Descope project. hCaptcha can help protect your applications from bots, spam, and other forms of automated abuse.",
	Attributes:          HCaptchaConnectorAttributes,
}

var HCaptchaConnectorAttributes = map[string]schema.Attribute{
...
type HCaptchaConnectorModel struct {
...
func (m *HCaptchaConnectorModel) Values(h *helpers.Handler) map[string]any {
	data := map[string]any{}
...
func (m *HCaptchaConnectorModel) SetValues(h *helpers.Handler, data map[string]any) {
...
func (m *HCaptchaConnectorModel) ConfigurationValues(h *helpers.Handler) map[string]any {
	c := map[string]any{}
...
func (m *HCaptchaConnectorModel) SetConfigurationValues(c map[string]any, h *helpers.Handler) {
...
func (m *HCaptchaConnectorModel) GetID() stringattr.Type        { return m.ID }
func (m *HCaptchaConnectorModel) SetID(id stringattr.Type)      { m.ID = id }
func (m *HCaptchaConnectorModel) GetProjectID() stringattr.Type { return m.ProjectID }
