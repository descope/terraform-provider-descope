...
// descope_sumologic_connector is a standalone Sumo Logic connector with a server-assigned id.

var SumoLogicConnectorSchema = schema.Schema{
	MarkdownDescription: "Manages a Sumo Logic connector and its configuration in a Descope project. Stream logs and audit events with the Sumo Logic connector.",
	Attributes:          SumoLogicConnectorAttributes,
}

var SumoLogicConnectorAttributes = map[string]schema.Attribute{
...
type SumoLogicConnectorModel struct {
...
func (m *SumoLogicConnectorModel) Values(h *helpers.Handler) map[string]any {
	data := map[string]any{}
...
func (m *SumoLogicConnectorModel) SetValues(h *helpers.Handler, data map[string]any) {
...
func (m *SumoLogicConnectorModel) Validate(h *helpers.Handler) {
...
func (m *SumoLogicConnectorModel) ConfigurationValues(h *helpers.Handler) map[string]any {
	c := map[string]any{}
...
func (m *SumoLogicConnectorModel) GetID() stringattr.Type        { return m.ID }
func (m *SumoLogicConnectorModel) SetID(id stringattr.Type)      { m.ID = id }
func (m *SumoLogicConnectorModel) GetProjectID() stringattr.Type { return m.ProjectID }
