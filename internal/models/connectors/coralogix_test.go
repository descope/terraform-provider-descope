...
func TestCoralogixConnector(t *testing.T) {
	projectID := testacc.ProjectID(t)
	c := testacc.NewResource(t, "coralogix_connector")
	testacc.RunWithDestroyCheck(t, "descope_coralogix_connector",
		// create a new coralogix connector
		resource.TestStep{
			Config: c.Config(`
