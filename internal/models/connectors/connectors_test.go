	...
	testacc.Run(t,
		...
		resource.TestStep{
					...
					"audit_webhook": [
						{
    						...
    						insecure = true
    						audit_filters = ["kekpon4oj34w", "event2"]
						}
					]
				}
			`),
			Check: p.Check(map[string]any{
				...
				"connectors.audit_webhook.0.audit_filters":               []string{"kekpon4oj34w", "event2"},
			}),
		},
		resource.TestStep{
			Config: p.Config(`
			...
			Check: p.Check(map[string]any{
				...
				"connectors.aws_s3.0.audit_filters":            []string{"kekpon4oj34w", "event2"},
		...
		resource.TestStep{
			...
			Check: p.Check(map[string]any{
				...
				"connectors.datadog.0.audit_filters":            []string{"kekpon4oj34w", "event2"},
		...
		resource.TestStep{
			...
			Check: p.Check(map[string]any{
				...
				"connectors.newrelic.0.audit_filters":            []string{"kekpon4oj34w", "event2"},
		...
		resource.TestStep{
			...
			Check: p.Check(map[string]any{
				...
				"connectors.sumologic.0.audit_filters":            []string{"kekpon4oj34w", "event2"},
