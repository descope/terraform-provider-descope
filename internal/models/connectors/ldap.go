...
func (m *LDAPConnectorModel) SetConfigurationValues(c map[string]any, h *helpers.Handler) {
	...
	stringattr.SetSecret(&m.BindPassword, c, "bindPassword", h)
	stringattr.SetSecret(&m.ClientCertificate, c, "clientCert", h)
	stringattr.SetSecret(&m.ClientKey, c, "clientKey", h)
	stringattr.SetSecret(&m.CACertificate, c, "caCert", h)
