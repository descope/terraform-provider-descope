...
func (m *ConnectorsModel) SetValues(h *helpers.Handler, data map[string]any) {
	listattr.SetMatching(&m.AbuseIPDB, data, "abuseipdb", h)
	listattr.SetMatching(&m.Amplitude, data, "amplitude", h)
	...
	listattr.SetMatching(&m.Bitsight, data, "bitsight", h)
	listattr.SetMatching(&m.Datadog, data, "datadog", h)
	listattr.SetMatching(&m.DevRevGrow, data, "devrev-grow", h)
	listattr.SetMatching(&m.Docebo, data, "docebo", h)
	listattr.SetMatching(&m.EightByEightViber, data, "eight-by-eight-viber", h)
	listattr.SetMatching(&m.EightByEightWhatsapp, data, "eight-by-eight-whatsapp", h)
	listattr.SetMatching(&m.Elephant, data, "elephant", h)
	listattr.SetMatching(&m.ExternalTokenHTTP, data, "external-token-http", h)
	listattr.SetMatching(&m.Fingerprint, data, "fingerprint", h)
	listattr.SetMatching(&m.FingerprintDescope, data, "fingerprint-descope", h)
	listattr.SetMatching(&m.FirebaseAdmin, data, "firebase-admin", h)
	listattr.SetMatching(&m.Forter, data, "forter", h)
	listattr.SetMatching(&m.GenericEmailGateway, data, "generic-email-gateway", h)
	...
	listattr.SetMatching(&m.Incode, data, "incode", h)
	listattr.SetMatching(&m.Intercom, data, "intercom", h)
	listattr.SetMatching(&m.Lokalise, data, "lokalise", h)
	listattr.SetMatching(&m.MParticle, data, "mparticle", h)
	listattr.SetMatching(&m.NewRelic, data, "newrelic", h)
	listattr.SetMatching(&m.Radar, data, "radar", h)
	listattr.SetMatching(&m.Recaptcha, data, "recaptcha", h)
	listattr.SetMatching(&m.RecaptchaEnterprise, data, "recaptcha-enterprise", h)
	listattr.SetMatching(&m.Rekognition, data, "rekognition", h)
	listattr.SetMatching(&m.Salesforce, data, "salesforce", h)
	listattr.SetMatching(&m.SalesforceMarketingCloud, data, "salesforce-marketing-cloud", h)
	listattr.SetMatching(&m.Sardine, data, "sardine", h)
	listattr.SetMatching(&m.Segment, data, "segment", h)
	listattr.SetMatching(&m.SendGrid, data, "sendgrid", h)
	listattr.SetMatching(&m.SES, data, "ses", h)
	listattr.SetMatching(&m.Slack, data, "slack", h)
	listattr.SetMatching(&m.Smartling, data, "smartling", h)
	listattr.SetMatching(&m.SMTP, data, "smtp", h)
	listattr.SetMatching(&m.SNS, data, "sns", h)
	listattr.SetMatching(&m.SumoLogic, data, "sumologic", h)
	listattr.SetMatching(&m.Supabase, data, "supabase", h)
	listattr.SetMatching(&m.Telesign, data, "telesign", h)
	listattr.SetMatching(&m.Traceable, data, "traceable", h)
	listattr.SetMatching(&m.Turnstile, data, "turnstile", h)
	listattr.SetMatching(&m.TwilioCore, data, "twilio-core", h)
	listattr.SetMatching(&m.TwilioVerify, data, "twilio-verify", h)
}
