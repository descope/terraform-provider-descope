...
func (m *ConnectorsModel) SetValues(h *helpers.Handler, data map[string]any) {
	listattr.SetMatching(&m.AbuseIPDB, data, "abuseipdb", "name", h)
	listattr.SetMatching(&m.Amplitude, data, "amplitude", "name", h)
	...
	listattr.SetMatching(&m.EightByEightViber, data, "eight-by-eight-viber", "name", h)
	listattr.SetMatching(&m.EightByEightWhatsapp, data, "eight-by-eight-whatsapp", "name", h)
	listattr.SetMatching(&m.Elephant, data, "elephant", "name", h)
	listattr.SetMatching(&m.ExternalTokenHTTP, data, "external-token-http", "name", h)
	listattr.SetMatching(&m.Fingerprint, data, "fingerprint", "name", h)
	listattr.SetMatching(&m.FingerprintDescope, data, "fingerprint-descope", "name", h)
	listattr.SetMatching(&m.FirebaseAdmin, data, "firebase-admin", "name", h)
	listattr.SetMatching(&m.Forter, data, "forter", "name", h)
	listattr.SetMatching(&m.GenericEmailGateway, data, "generic-email-gateway", "name", h)
	listattr.SetMatching(&m.GenericSMSGateway, data, "generic-sms-gateway", "name", h)
	listattr.SetMatching(&m.GoogleCloudTranslation, data, "google-cloud-translation", "name", h)
	listattr.SetMatching(&m.GoogleMapsPlaces, data, "google-maps-places", "name", h)
	listattr.SetMatching(&m.GoogleCloudLogging, data, "googlecloudlogging", "name", h)
	listattr.SetMatching(&m.HIBP, data, "hibp", "name", h)
	listattr.SetMatching(&m.HTTP, data, "http", "name", h)
	listattr.SetMatching(&m.HubSpot, data, "hubspot", "name", h)
	listattr.SetMatching(&m.Incode, data, "incode", "name", h)
	listattr.SetMatching(&m.Intercom, data, "intercom", "name", h)
	listattr.SetMatching(&m.Lokalise, data, "lokalise", "name", h)
	listattr.SetMatching(&m.MParticle, data, "mparticle", "name", h)
	listattr.SetMatching(&m.NewRelic, data, "newrelic", "name", h)
	listattr.SetMatching(&m.Radar, data, "radar", "name", h)
	listattr.SetMatching(&m.Recaptcha, data, "recaptcha", "name", h)
	listattr.SetMatching(&m.RecaptchaEnterprise, data, "recaptcha-enterprise", "name", h)
	listattr.SetMatching(&m.Rekognition, data, "rekognition", "name", h)
	listattr.SetMatching(&m.Salesforce, data, "salesforce", "name", h)
	listattr.SetMatching(&m.SalesforceMarketingCloud, data, "salesforce-marketing-cloud", "name", h)
	listattr.SetMatching(&m.Sardine, data, "sardine", "name", h)
	listattr.SetMatching(&m.Segment, data, "segment", "name", h)
	listattr.SetMatching(&m.SendGrid, data, "sendgrid", "name", h)
	listattr.SetMatching(&m.SES, data, "ses", "name", h)
	listattr.SetMatching(&m.Slack, data, "slack", "name", h)
	listattr.SetMatching(&m.Smartling, data, "smartling", "name", h)
	listattr.SetMatching(&m.SMTP, data, "smtp", "name", h)
	listattr.SetMatching(&m.SNS, data, "sns", "name", h)
	listattr.SetMatching(&m.SumoLogic, data, "sumologic", "name", h)
	listattr.SetMatching(&m.Supabase, data, "supabase", "name", h)
	listattr.SetMatching(&m.Telesign, data, "telesign", "name", h)
	listattr.SetMatching(&m.Traceable, data, "traceable", "name", h)
	listattr.SetMatching(&m.Turnstile, data, "turnstile", "name", h)
	listattr.SetMatching(&m.TwilioCore, data, "twilio-core", "name", h)
	listattr.SetMatching(&m.TwilioVerify, data, "twilio-verify", "name", h)
}
...
func (m *ConnectorsModel) Modify(h *helpers.Handler, state *ConnectorsModel) {
	listattr.ModifyMatching(h, &m.AbuseIPDB, state.AbuseIPDB)
	listattr.ModifyMatching(h, &m.Amplitude, state.Amplitude)
	...
	listattr.ModifyMatching(h, &m.EightByEightViber, state.EightByEightViber)
	listattr.ModifyMatching(h, &m.EightByEightWhatsapp, state.EightByEightWhatsapp)
	listattr.ModifyMatching(h, &m.Elephant, state.Elephant)
	listattr.ModifyMatching(h, &m.ExternalTokenHTTP, state.ExternalTokenHTTP)
	listattr.ModifyMatching(h, &m.Fingerprint, state.Fingerprint)
	listattr.ModifyMatching(h, &m.FingerprintDescope, state.FingerprintDescope)
	listattr.ModifyMatching(h, &m.FirebaseAdmin, state.FirebaseAdmin)
	listattr.ModifyMatching(h, &m.Forter, state.Forter)
	listattr.ModifyMatching(h, &m.GenericEmailGateway, state.GenericEmailGateway)
	...
	listattr.ModifyMatching(h, &m.Incode, state.Incode)
	listattr.ModifyMatching(h, &m.Intercom, state.Intercom)
	listattr.ModifyMatching(h, &m.Lokalise, state.Lokalise)
	listattr.ModifyMatching(h, &m.MParticle, state.MParticle)
	listattr.ModifyMatching(h, &m.NewRelic, state.NewRelic)
	listattr.ModifyMatching(h, &m.Radar, state.Radar)
	listattr.ModifyMatching(h, &m.Recaptcha, state.Recaptcha)
	listattr.ModifyMatching(h, &m.RecaptchaEnterprise, state.RecaptchaEnterprise)
	listattr.ModifyMatching(h, &m.Rekognition, state.Rekognition)
	listattr.ModifyMatching(h, &m.Salesforce, state.Salesforce)
	listattr.ModifyMatching(h, &m.SalesforceMarketingCloud, state.SalesforceMarketingCloud)
	listattr.ModifyMatching(h, &m.Sardine, state.Sardine)
	listattr.ModifyMatching(h, &m.Segment, state.Segment)
	listattr.ModifyMatching(h, &m.SendGrid, state.SendGrid)
	listattr.ModifyMatching(h, &m.SES, state.SES)
	listattr.ModifyMatching(h, &m.Slack, state.Slack)
	listattr.ModifyMatching(h, &m.Smartling, state.Smartling)
	listattr.ModifyMatching(h, &m.SMTP, state.SMTP)
	listattr.ModifyMatching(h, &m.SNS, state.SNS)
	listattr.ModifyMatching(h, &m.SumoLogic, state.SumoLogic)
	listattr.ModifyMatching(h, &m.Supabase, state.Supabase)
	listattr.ModifyMatching(h, &m.Telesign, state.Telesign)
	listattr.ModifyMatching(h, &m.Traceable, state.Traceable)
	listattr.ModifyMatching(h, &m.Turnstile, state.Turnstile)
	listattr.ModifyMatching(h, &m.TwilioCore, state.TwilioCore)
	listattr.ModifyMatching(h, &m.TwilioVerify, state.TwilioVerify)
